 ...
 * 
 * A singleton? class that is responsible for handling unit tests
 *
 */
...
// initialize the static unit tester variables
//bool      UnitTester::stillPassing = true;
//string    UnitTester::testerName = "Unnamed";
